...
import controller.CelebController;
...
public class StartPanel extends JPanel
{
	 ...
	 */
	private CelebController controller;
	 ...
	 */
	public StartPanel(CelebController controller)
	{
		super();
	...
	private void setupListeners()
	{
		...
		addCelebrityButton.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent mouseClick)
			{
				...
				celebrityCount = controller.getCelebrityListSize();
